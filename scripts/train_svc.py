...
def main():
    ...
    scaler = RobustScaler(quantile_range=(10.0, 90.0), with_scaling=False)
    model = SVC(kernel=args.kernel, C=args.penalty, probability=False) 

    clf = make_pipeline(imputer, scaler, model)
